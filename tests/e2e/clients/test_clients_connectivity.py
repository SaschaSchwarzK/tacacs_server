    ...
    try:
        ...
        _assert_cmd(
            [
                ...
                "sh",
                "-lc",
                f"python /app/client.py --mode tacacs --host {server_container} --port 8049 --secret TacacsSecret123! --username user_accept --password GoodPass1!",
            ],
            server_container,
        ...
        _assert_cmd(
            [
                ...
                "sh",
                "-lc",
                f"python /app/client.py --mode tacacs --host {server_container} --port 8049 --secret TacacsSecret123! --username user_reject --password WrongPass!",
            ],
            server_container,

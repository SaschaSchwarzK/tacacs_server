    ...
    try:
        ...
        _assert_cmd(
            [
                ...
                "sh",
                "-lc",
                f"python /app/client.py --mode tacacs --host {proxy1} --port 5049 --secret TacacsSecret123! --username user_reject --password WrongPass!",
            ],
            server_container,
        ...
        _assert_cmd(
            [
                ...
                "sh",
                "-lc",
                f"python /app/client.py --mode tacacs --host {proxy2} --port 5049 --secret TacacsSecret123! --username user_reject --password WrongPass!",
            ],
            server_container,

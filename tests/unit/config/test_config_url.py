...
def test_url_fetch_and_cache(isolated_config_store, monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    ...
    monkeypatch.setattr(url_handler.URLConfigHandler, "is_url_safe", lambda self, s: True)
    monkeypatch.setattr(url_handler.URLConfigHandler, "load_from_url", mock_load_from_url)

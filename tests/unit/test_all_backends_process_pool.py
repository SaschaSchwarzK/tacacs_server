...
def test_process_pool_vs_thread_pool_usage():
    ...
    handlers = AAAHandlers([local_backend, unsupported_backend], None, backend_process_pool_size=1)
...
def test_process_pool_worker_receives_correct_configs(mock_worker):
    ...
    handlers = AAAHandlers([local_backend, ldap_backend], None, backend_process_pool_size=1)
